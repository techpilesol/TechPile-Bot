...
function initializeChatbot(config) {
    ...
    Promise.all([
        ...
        welcomeMessage.innerHTML = `Welcome! I'm here to help you with questions about <strong>${chatbotName}</strong>. What would you like to know?`;
    ...
    function initializeChatbotLogic(currentUrl, extraUrls, prefixes, chatbotName, wsUrl, instruction = '', isOpenByDefault = false, wasCurrentUrlProvided = false) {
        ...
        function clearChatHistory() {
            ...
            const welcomeMessageContainer = chatMessages.querySelector('.pocketflow-message-container');
        ...
        function connectWebSocket() {
            ...
            socket.onmessage = async (event) => {
                ...
                switch (data.type) {
                    ...
                    case 'progress':
                        // Just show typing indicator, don't display crawl progress as messages
                        showTyping();
                        break;
                }
            };
        ...
        async function sendMessage() {
            ...
            if (hasPageChanged) {
                ...
                clearChatHistory();
                hasPageChanged = false;
            } else if (isFirstMessage && chatMessages.children.length > 2) {
        ...
        function handlePageChange(newUrl) {
            ...
            const hasExistingHistory = chatMessages.children.length > 2; // welcome container + clear div
